...
public class PerformanceService {
    ...
    public CreatePerformance create(CreatePerformanceCommand createPerformanceCommand) {
        ...
        Performance newPerformance =
            new Performance(
                place,
                Performance.Category.valueOf(createPerformanceCommand.category()),
                createPerformanceCommand.startAt(),
                createPerformanceCommand.endAt(),
                createPerformanceCommand.startReservationAt(),
                createPerformanceCommand.endReservationAt(),
                createPerformanceCommand.title(),
                createPerformanceCommand.content(),
                createPerformanceCommand.acting(),
                Performance.FilmRating.valueOf(createPerformanceCommand.filmRating())
            );
